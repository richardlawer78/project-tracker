...
var spark03 = {
    chart: {
        ...
        dropShadow: {
            ...
            left: 0,
            blur: 3,
            color: "rgba(0, 123, 255, 0.3)", // Replace with a valid RGBA color
            opacity: 0.3,
        },
    },
    grid: {
    ...
    colors: ["#007bff"], // Replace with a valid HEX or RGB color
};
var chart = new ApexCharts(document.querySelector("#eth-marketcap"), spark03);
chart.render();
...
mainchart = new ApexCharts(document.querySelector("#crypto-analysis"), mainchart);
mainchart.render();
/* crypto analysis chart */
